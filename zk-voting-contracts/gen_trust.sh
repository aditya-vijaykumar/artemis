...
snarkjs groth16 setup ../artemis.r1cs pot12_final.ptau artemis_0000.zkey

echo 'contribute to the phase 2 of the ceremony...'
snarkjs zkey contribute artemis_0000.zkey artemis_0001.zkey --name="1st Contributor Name" -v

echo 'generate solidity code...'
snarkjs zkey export verificationkey artemis_0001.zkey verification_key.json

snarkjs zkey export solidityverifier artemis_0001.zkey ../../contracts/Verifier.sol